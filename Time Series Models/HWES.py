...
# fit model - Paramerters --> seasonal_periods, seasonal, trend
#model = ExponentialSmoothing(train)
#model = ExponentialSmoothing(train, seasonal_periods= 4, seasonal= 'add',trend= 'add')
model = ExponentialSmoothing(train, seasonal_periods= 4, seasonal= 'add')
model_fit = model.fit()
# make prediction
